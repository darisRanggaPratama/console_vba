				...
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					...
					<tbody>
						<tr>
							...
							<td>
								<div align="center">
									<strong>Minimum Reorder Quantity</strong>
								</div>
							</td>
							<td>
								<div align="center">
					...
					<tbody id="CTRL2">
						<xsl:for-each select="Products">
							...
							<tr>
								<td>
									<xsl:value-of select="Supplier_x0020_IDs"/>
								</td>
								<td>
									<xsl:value-of select="ID"/>
								</td>
								<td>
									<xsl:value-of select="Product_x0020_Code"/>
								</td>
								<td>
								...
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Standard_x0020_Cost', 'Currency', 'auto', '1033', 6)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('List_x0020_Price', 'Currency', 'auto', '1033', 6)"/>
								</td>
								<td>
									<xsl:value-of select="Reorder_x0020_Level"/>
								</td>
								<td>
									<xsl:value-of select="Target_x0020_Level"/>
								</td>
								<td>
									<xsl:value-of select="Quantity_x0020_Per_x0020_Unit"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Discontinued', 'Yes/No', '', '', 11)"/>
								</td>
								<td>
									<xsl:value-of select="Minimum_x0020_Reorder_x0020_Quantity"/>
								</td>
								<td>
